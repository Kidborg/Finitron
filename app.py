...
class Text2ImageAPI:
    ...
    def generate(self, prompt, model, images=1, width=480, height=480):
        params = {
            "type": "GENERATE",
            "numImages": images,
            "width": width,
